...
public class FilterPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject, 253.15f, 293.15f, 383.15f, 443.15f, null, pressure_sensitive: true, 0f, 0.15f, SimHashes.Water.ToString(), can_drown: true, can_tinker: true, require_solid_tile: true, should_grow_old: true, 2400f, 0f, 220f, "FilterPlantOriginal", STRINGS.CREATURES.SPECIES.FILTERPLANT.NAME);
		...
		gameObject.AddOrGet<PressureVulnerable>().Configure(0.025f, 0f, 10f, 30f, new SimHashes[1] { SimHashes.Oxygen });
