...
public class PropGravitasLabWindowConfig : IBuildingConfig
{
	...
	{
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("PropGravitasLabWindow", 2, 3, "gravitas_lab_window_kanim", 30, 30f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER_TINY, MATERIALS.GLASSES, 1600f, BuildLocationRule.NotInTiles, noise: NOISE_POLLUTION.NONE, decor: DECOR.BONUS.TIER0);
