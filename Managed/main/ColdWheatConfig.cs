...
public class ColdWheatConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		}, pressure_sensitive: true, 0f, 0.15f, "ColdWheatSeed", can_drown: true, can_tinker: true, require_solid_tile: true, should_grow_old: true, 2400f, "ColdWheatOriginal", STRINGS.CREATURES.SPECIES.COLDWHEAT.NAME);
		...
		{
			GameTags.CropSeed
		}, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 2, STRINGS.CREATURES.SPECIES.COLDWHEAT.DOMESTICATEDDESC, EntityTemplates.CollisionShape.CIRCLE, 0.2f, 0.2f, null, "", ignoreDefaultSeedTag: true);
