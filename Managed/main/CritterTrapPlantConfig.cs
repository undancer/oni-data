...
public class CritterTrapPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject, 248.15f, 295.15f, 338.15f, 398.15f, null, pressure_sensitive: false, 0f, 0.15f, "PlantMeat", can_drown: true, can_tinker: true, require_solid_tile: true, should_grow_old: false);
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, SeedProducer.ProductionType.Hidden, "CritterTrapPlantSeed", STRINGS.CREATURES.SPECIES.SEEDS.CRITTERTRAPPLANT.NAME, STRINGS.CREATURES.SPECIES.SEEDS.CRITTERTRAPPLANT.DESC, Assets.GetAnim("seed_sealettuce_kanim"), "object", 1, new List<Tag>
		{
			GameTags.CropSeed
		}, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 4, STRINGS.CREATURES.SPECIES.CRITTERTRAPPLANT.DOMESTICATEDDESC, EntityTemplates.CollisionShape.CIRCLE, 0.3f, 0.3f);
		EntityTemplates.CreateAndRegisterPreviewForPlant(seed, "CritterTrapPlant_preview", Assets.GetAnim("sea_lettuce_kanim"), "place", 1, 2);
		return gameObject;
	}
