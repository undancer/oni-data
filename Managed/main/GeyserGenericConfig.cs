...
public class GeyserGenericConfig : IMultiEntityConfig
{
	...
	private List<GeyserPrefabParams> GenerateConfigs()
	{
		List<GeyserPrefabParams> obj = new List<GeyserPrefabParams>
		{
			...
			new GeyserPrefabParams("geyser_liquid_water_slush_kanim", 4, 2, new GeyserConfigurator.GeyserType("slush_water", SimHashes.DirtyWater, 263.15f, 1000f, 2000f, 500f))
		};
		...
		obj.Add(new GeyserPrefabParams("geyser_liquid_co2_kanim", 4, 2, new GeyserConfigurator.GeyserType("liquid_co2", SimHashes.LiquidCarbonDioxide, 218f, 100f, 200f, 50f)));
