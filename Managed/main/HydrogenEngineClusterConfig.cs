...
public class HydrogenEngineClusterConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("HydrogenEngineCluster", 7, 5, "rocket_cluster_hydrogen_engine_kanim", 1000, 60f, BUILDINGS.ROCKETRY_MASS_KG.ENGINE_MASS_LARGE, new string[1]
		{
