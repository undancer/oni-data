...
namespace Database
{
	public class Amounts : ResourceSet<Amount>
	{
		...
		public void Load()
		{
			Stamina = CreateAmount("Stamina", 0f, 100f, show_max: false, Units.Flat, 0.35f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_stamina", "attribute_stamina");
			Stamina.SetDisplayer(new StandardAmountDisplayer(GameUtil.UnitClass.Percent, GameUtil.TimeSlice.PerCycle));
			Calories = CreateAmount("Calories", 0f, 0f, show_max: false, Units.Flat, 4000f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_calories", "attribute_calories");
			...
			Breath = CreateAmount("Breath", 0f, 100f, show_max: false, Units.Flat, 0.5f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_breath");
			Breath.SetDisplayer(new StandardAmountDisplayer(GameUtil.UnitClass.Percent, GameUtil.TimeSlice.PerSecond));
			Stress = CreateAmount("Stress", 0f, 100f, show_max: false, Units.Flat, 0.5f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_stress", "attribute_stress");
			...
			Bladder = CreateAmount("Bladder", 0f, 100f, show_max: false, Units.Flat, 0.5f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_bladder");
			Bladder.SetDisplayer(new StandardAmountDisplayer(GameUtil.UnitClass.Percent, GameUtil.TimeSlice.PerCycle));
			Decor = CreateAmount("Decor", -1000f, 1000f, show_max: false, Units.Flat, 0.016666668f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_decor");
			...
			HitPoints = CreateAmount("HitPoints", 0f, 0f, show_max: true, Units.Flat, 0.1675f, show_in_ui: true, "STRINGS.DUPLICANTS", "ui_icon_hitpoints", "attribute_hitpoints");
		...
		public Amount CreateAmount(string id, float min, float max, bool show_max, Units units, float delta_threshold, bool show_in_ui, string string_root, string uiSprite = null, string thoughtSprite = null)
		{
			...
			Attribute attribute = new Attribute(id + "Min", name, "", attribute_description, min, Attribute.Display.Normal, is_trainable: false);
			string text3 = id + "Max";
			StringEntry result3;
			...
			Attribute attribute2 = new Attribute(id + "Max", name2, "", attribute_description2, max, Attribute.Display.Normal, is_trainable: false);
			...
			Attribute attribute3 = new Attribute(text4, name3, "", attribute_description3, 0f, Attribute.Display.Normal, is_trainable: false);
