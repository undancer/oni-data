...
namespace Database
{
	public class Techs : ResourceSet<Tech>
	{
		...
		public void Init()
		{
			...
			new Tech("PrecisionPlumbing", new List<string> { "EspressoMachine", "LiquidFuelTankCluster" }, this);
			...
			new Tech("Catalytics", new List<string> { "OxyliteRefinery", "SupermaterialRefinery", "SodaFountain", "GasCargoBayCluster" }, this);
			...
			new Tech("HydrocarbonPropulsion", new List<string> { "KeroseneEngineClusterSmall" }, this);
			...
			new Tech("Suits", new List<string> { "SuitsOverlay", "AtmoSuit", "SuitFabricator", "ExteriorWall", "SuitMarker", "SuitLocker" }, this);
			new Tech("Jobs", new List<string> { "WaterCooler", "CraftingTable" }, this);
			...
			new Tech("EnginesI", new List<string> { "SolidBooster" }, this);
			...
			new Tech("Jetpacks", new List<string> { "JetSuit", "JetSuitMarker", "JetSuitLocker", "LiquidCargoBayCluster" }, this);
			...
			new Tech("PortableGasses", new List<string> { "GasBottler", "BottleEmptierGas", "OxygenMask", "OxygenMaskLocker", "OxygenMaskMarker" }, this);
			InitExpansion1();
		}
