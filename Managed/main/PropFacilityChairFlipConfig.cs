...
public class PropFacilityChairFlipConfig : IEntityConfig
{
	...
	{
		GameObject obj = EntityTemplates.CreatePlacedEntity("PropFacilityChairFlip", STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHAIR.NAME, STRINGS.BUILDINGS.PREFABS.PROPFACILITYCHAIR.DESC, 50f, decor: TUNING.BUILDINGS.DECOR.BONUS.TIER0, noise: NOISE_POLLUTION.NOISY.TIER0, anim: Assets.GetAnim("gravitas_chairFlip_kanim"), initialAnim: "off", sceneLayer: Grid.SceneLayer.Building, width: 2, height: 2, element: SimHashes.Creature, additionalTags: new List<Tag>
		{
			GameTags.Gravitas
		});
