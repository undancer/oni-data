...
namespace Klei.AI
{
	public class HeatRash : Sickness
	{
		...
		public HeatRash()
			: base("HeatSickness", SicknessType.Ailment, Severity.Minor, 0.005f, new List<InfectionVector> { InfectionVector.Inhalation }, 180f)
		{
			...
			AddSicknessComponent(new PeriodicEmoteSickness("anim_idle_hot_kanim", new HashedString[3] { "idle_pre", "idle_default", "idle_pst" }, 15f));
		}
	}
}
