...
public class SteamEngineClusterConfig : IBuildingConfig
{
	...
	{
		BuildingDef obj = BuildingTemplates.CreateBuildingDef("SteamEngineCluster", 7, 5, "rocket_cluster_steam_engine_kanim", 1000, 480f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER7, new string[1]
		{
