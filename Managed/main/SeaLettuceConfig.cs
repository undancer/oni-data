...
public class SeaLettuceConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject, 248.15f, 295.15f, 338.15f, 398.15f, new SimHashes[3]
		{
			...
			SimHashes.SaltWater,
			SimHashes.Brine
		}, pressure_sensitive: false, 0f, 0.15f, "Lettuce");
		...
		{
			GameTags.WaterSeed
		}, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 1, STRINGS.CREATURES.SPECIES.SEALETTUCE.DOMESTICATEDDESC), ID + "_preview", Assets.GetAnim("sea_lettuce_kanim"), "place", 1, 2);
