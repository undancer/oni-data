...
public class ReportManager : KMonoBehaviour
{
	...
	public Dictionary<ReportType, ReportGroup> ReportGroups = new Dictionary<ReportType, ReportGroup>
	{
		...
		},
		{
			...
			new ReportGroup(null, reportIfZero: false, 1, UI.ENDOFDAYREPORT.NUMBER_OF_DOMESTICATED_CRITTERS.NAME, UI.ENDOFDAYREPORT.NUMBER_OF_DOMESTICATED_CRITTERS.POSITIVE_TOOLTIP, UI.ENDOFDAYREPORT.NUMBER_OF_DOMESTICATED_CRITTERS.NEGATIVE_TOOLTIP, ReportEntry.Order.Descending, ReportEntry.Order.Descending)
		},
		{
			ReportType.WildCritters,
			new ReportGroup(null, reportIfZero: false, 1, UI.ENDOFDAYREPORT.NUMBER_OF_WILD_CRITTERS.NAME, UI.ENDOFDAYREPORT.NUMBER_OF_WILD_CRITTERS.POSITIVE_TOOLTIP, UI.ENDOFDAYREPORT.NUMBER_OF_WILD_CRITTERS.NEGATIVE_TOOLTIP, ReportEntry.Order.Descending, ReportEntry.Order.Descending)
		},
		{
			ReportType.RocketsInFlight,
			new ReportGroup(null, reportIfZero: false, 1, UI.ENDOFDAYREPORT.ROCKETS_IN_FLIGHT.NAME, UI.ENDOFDAYREPORT.ROCKETS_IN_FLIGHT.POSITIVE_TOOLTIP, UI.ENDOFDAYREPORT.ROCKETS_IN_FLIGHT.NEGATIVE_TOOLTIP, ReportEntry.Order.Descending, ReportEntry.Order.Descending)
		},
		{
