...
public class BasicFabricMaterialPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject, 248.15f, 295.15f, 310.15f, 398.15f, crop_id: BasicFabricConfig.ID, safe_elements: new SimHashes[5]
		{
			...
			SimHashes.Water
		}, pressure_sensitive: false, pressure_lethal_low: 0f, pressure_warning_low: 0.15f, can_drown: false, can_tinker: true, require_solid_tile: true, should_grow_old: true, max_age: 2400f, baseTraitId: ID + "Original", baseTraitName: STRINGS.CREATURES.SPECIES.BASICFABRICMATERIALPLANT.NAME);
		...
		GameObject seed = EntityTemplates.CreateAndRegisterSeedForPlant(gameObject, SeedProducer.ProductionType.Harvest, SEED_ID, STRINGS.CREATURES.SPECIES.SEEDS.BASICFABRICMATERIALPLANT.NAME, STRINGS.CREATURES.SPECIES.SEEDS.BASICFABRICMATERIALPLANT.DESC, Assets.GetAnim("seed_swampreed_kanim"), "object", 0, new List<Tag>
		{
			GameTags.WaterSeed
		}, SingleEntityReceptacle.ReceptacleDirection.Top, default(Tag), 1, STRINGS.CREATURES.SPECIES.BASICFABRICMATERIALPLANT.DOMESTICATEDDESC);
