...
public class TemperatureSuitConfig : IEquipmentConfig
{
	...
	public EquipmentDef CreateEquipmentDef()
	{
		...
		EquipmentDef equipmentDef = EquipmentTemplates.CreateEquipmentDef("Temperature_Suit", TUNING.EQUIPMENT.SUITS.SLOT, SimHashes.Water, TUNING.EQUIPMENT.SUITS.TEMPERATURESUIT_MASS, TUNING.EQUIPMENT.SUITS.ANIM, TUNING.EQUIPMENT.SUITS.SNAPON, "body_oxygen_kanim", 6, list, null, IsBody: false, EntityTemplates.CollisionShape.CIRCLE, 0.325f, 0.325f, new Tag[2]
		{
			GameTags.Suit,
			GameTags.Clothes
		});
