...
public struct TagBits
{
	...
	{
		return ((bits0 & tag_bits.bits0) | (bits1 & tag_bits.bits1) | (bits2 & tag_bits.bits2) | (bits3 & tag_bits.bits3) | (bits4 & tag_bits.bits4) | (bits5 & tag_bits.bits5) | (bits6 & tag_bits.bits6) | (bits7 & tag_bits.bits7)) != 0;
	}
