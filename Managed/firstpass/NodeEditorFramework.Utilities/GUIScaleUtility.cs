...
namespace NodeEditorFramework.Utilities
{
	public static class GUIScaleUtility
	{
		...
		public static void Init()
		{
			...
			MethodInfo method2 = type.GetMethod("Clip", BindingFlags.Static | BindingFlags.Public, Type.DefaultBinder, new Type[1] { typeof(Rect) }, new ParameterModifier[0]);
		...
		public static void BeginNewLayout()
		{
			...
			{
				Rect rect = getTopRect;
				if (rect != new Rect(-10000f, -10000f, 40000f, 40000f))
				{
