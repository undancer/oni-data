	...
	public class UILineRenderer : UIPrimitiveBase
	{
		...
		protected override void OnPopulateMesh(VertexHelper vh)
		{
			...
			for (int k = 0; k < list.Count; k++)
			{
				...
				{
					Vector3 v = list[k][1].position - list[k][2].position;
					Vector3 v2 = list[k + 1][2].position - list[k + 1][1].position;
					...
					Vector3 position = list[k][2].position - v.normalized * num7 * num6;
					Vector3 position2 = list[k][3].position + v.normalized * num7 * num6;
